...
gui_editor = "gedit"
graphics   = "gimp"
musiplr   = "urxvt -e ncmpcpp "
launcher   = "gmrun"
fmanager   = "pcmanfm"
sufmanager = "gksu pcmanfm"
...
-- Calendar
mytextcalendar = awful.widget.textclock(markup("#FFFFFF", space3 .. "%d %b<span font='Terminus 5'> </span>"))
...
mpdwidget = lain.widgets.mpd({
    settings = function ()
        if mpd_now.state == "play" then
            ...
            widget:set_markup(markup.font("Terminus 4", " ")
                              .. markup.font("Terminus 8",
                              mpd_now.artist
                              .. " - " ..
                              mpd_now.title
        ...
        elseif mpd_now.state == "pause" then
            widget:set_markup(markup.font("Terminus 4", " ") ..
                              markup.font("Terminus 8", "MPD PAUSED") ..
                              markup.font("Terminus 10", " "))
            play_pause_icon:set_image(beautiful.play)
        else
            widget:set_markup("")
...
function () awful.util.spawn_with_shell("urxvt -e ncmpcpp") end)))
...
-- Separators
first = wibox.widget.textbox('<span font="Terminus 4"> </span>')
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "Escape", function () awful.util.spawn(fmanager) end),
    awful.key({ modkey, "Shift" }, "Escape", function () awful.util.spawn(sufmanager) end),
    ...
    -- User programs
    awful.key({ modkey }, "o", function () awful.util.spawn(browser) end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Up",     function () awful.util.spawn_with_shell("mpc | head -1 >> ~/Music/tobedownloaded.txt") end),
